# [16673. 고려대학교에는 공식 와인이 있다](https://www.acmicpc.net/problem/16673)
...
Kn+Pn
2
 만큼의 와인을 사는 것을 목표로 했다. 
K
는 수빈이의 고려대 애착 정도를 나타내는 상수이고, 
P
는 수빈이의 구매중독 정도를 나타내는 상수이다. 


그렇게 수빈이는 
C
년 동안 열심히 와인을 모았다. (마지막 해에 산 와인의 수는 
KC + PC
2
가 된다.)
...
|--------|------|--------|------|-----------|-----------|
| Bronze 3 | C++17 / 수정 | 2020 KB | 0 ms | 150 B | 9달 전 |
