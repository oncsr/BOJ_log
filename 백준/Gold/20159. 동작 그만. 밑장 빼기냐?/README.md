...
|--------|------|------|----------|----------|
| 25440 KB | 300 ms | Java 15 | 1158 B | 2026년 4월 4일 23:36:21 |

## 문제 설명
싸늘하다. 정훈이는 다음과 같은 도박을 하고 있다.

*N*개의 카드와 2명의 플레이어가 있다. 플레이어가 자신과 상대방에게 번갈아 가며 카드의 윗장부터 한 장씩 분배한다. 단, 카드는 분배한 사람부터 받는다. 카드를 모두 분배했을 때 카드에 적힌 수의 합이 더 큰 사람이 이긴다. 두 명이 공평하게 카드를 나눠 갖기 위해 카드의 개수는 짝수로 주어진다.
...
## 입력
카드의 개수 *N* (2 ≤ *N* ≤ 100,000)이 주어진다. 단, *N*은 짝수이다.
