...
|--------|------|------|----------|----------|
| 21324 KB | 536 ms | Java 15 | 1497 B | 2026년 4월 4일 23:23:57 |

## 문제 설명
N<sup>2</sup>개의 동전이 N행 N열을 이루어 탁자 위에 놓여 있다. 그 중 일부는 앞면(H)이 위를 향하도록 놓여 있고, 나머지는 뒷면(T)이 위를 향하도록 놓여 있다. <그림 1>은 N이 3일 때의 예이다.

![](https://upload.acmicpc.net/ccc3937a-da21-460e-b1f4-2ee861f03995/-/preview/)
...
| ![](https://upload.acmicpc.net/410bd5fd-cb16-4bfb-83af-7edd9882e188/-/preview/) | ![](https://upload.acmicpc.net/ae08cc98-4db2-4df7-8bb6-0149d1ca59ba/-/preview/) |
| --- | --- |
| <그림 2> | <그림 3> |
