...
대회를 개최하기 위해서는 $N$개의 건물에서 한 번씩 
차례대로
 회의를 진행해야 한다. 구체적으로, 회의를 진행해야 하는 건물의 순서 $A_1,A_2,\cdots ,A_N$이 주어진다. $i$번째로 진행해야 하는 회의는 $A_i$번 건물에서 진행되며, 모든 $A_i$는 서로 다르다.
...
|--------|------|--------|------|-----------|-----------|
| Gold 3 | C++17 / 수정 | 2344 KB | 0 ms | 567 B | 2달 전 |
